from domains.multi_agent.tiger.tiger_scenario import initial_state, actions, transition, observations, utility, end

from domains.single_agent.tiger.partial_observability import po_transition, po_utility, po_actions, po_end
...
def tiger_partial_obs_test():
    ...
    while not scenario.end(belief_state):
        # Plan
        node = search(belief_state, scenario, iterations=1000)
